...
const App = () => {
    ...
    const anecdoteOfDay = "Päivän anekdootti";
    const mostVotes = "Äänestetyin anekdootti";
    const [selected, setSelected] = useState(0)
    const [voteDisplay, setVotes] = useState(0)
    const [votedDisplay, setMostVoted] = useState(0)
    ...
    return (
        <div>
            ...
            <Display value = {votedDisplay}/>
            <Display value = {"has " + Math.max(...copy) + " votes"}/>
        </div>
    )
}
